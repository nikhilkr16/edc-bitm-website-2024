...
<label className=" flex flex-col" > 
  <div className="  flex h-10 md:w-72 ">
  <input onChange={handleChange} type="email"  name="email" id="email"  value={email} placeholder="enter your email here..."  required className="h-10 w-full  pl-7 pt-1 pb-1  text-sm rounded-tl-3xl rounded-bl-3xl"> 
  </input>
          ...
          <div className=" sb__footer-links_div w-auto ">
            ...
            <div className="flex flex-col md:flex-row justify-center gap-8">
              ...
              <div className="min-w-[150px] md:min-w-[100px]">
                ...
                >
                  <p className="hover:text-yellow-400">Pranav Srivastava</p>
                </a>
                <a

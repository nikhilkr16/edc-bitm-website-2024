    ...
    <div className="slider-container">
      <Slider {...settings}>
        <div className="flex flex-col justify-center items-center text-center p-16">
            <p>Engaging in Entrepreneurship Development Club's events like Ancient Entrepreneurship, Quiz Trivia, and Stock Stoicism has been incredibly enriching. These events offered insights into historical business practices, tested our knowledge, and taught valuable financial strategies.
            </p>
